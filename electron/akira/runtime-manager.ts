...
export class HermesRuntimeManager extends EventEmitter {
  ...
  private writeManagedFiles(): void {
    ...
    fs.writeFileSync(path.join(hermesHome, "SOUL.md"), [
      ...
      "In ordinary conversation, answer in one or two natural, grammatically complete paragraphs. Do not use bullets, numbered lists, fragments, or unnecessary parenthetical asides unless the user explicitly requests a structured format.",
      "Keep spoken replies concise and conversational so they sound natural when read aloud.",
      ...
      "Interpret 'projects' or 'my projects' as the Idea Workshop route /idea-workshop. For an explicit open, show, pull up, or go-to request, call rome.navigate immediately instead of scanning workspace data first.",
    ...
    fs.writeFileSync(path.join(skillDir, "SKILL.md"), [
      ...
      "For direct navigation, use rome.navigate immediately. Projects and my projects mean /idea-workshop.",
