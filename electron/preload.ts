...
contextBridge.exposeInMainWorld("romeDesktop", {
  ...
  akira: {
    ...
    verifyKey: () => ipcRenderer.invoke("rome:akira:verify-key"),
    probeServer: () => ipcRenderer.invoke("rome:akira:probe-server"),
    auditAgent: () => ipcRenderer.invoke("rome:akira:audit-agent"),
    repairAgent: () => ipcRenderer.invoke("rome:akira:repair-agent"),
    suppressGreeting: () => ipcRenderer.send("rome:akira:suppress-greeting"),
    ...
    announce: (text: string) => ipcRenderer.invoke("rome:akira:announce", text),
    setFocus: (state: unknown) => ipcRenderer.send("rome:akira:focus", state),
