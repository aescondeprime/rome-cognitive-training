...
The repair action requires the [`uv` package manager](https://docs.astral.sh/uv/) and installs `hermes-agent[voice,wake]` into Akira's managed runtime directory. Runtime download and model initialization happen after the ROME window is usable.
